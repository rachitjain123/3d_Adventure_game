...
Island_Fireball::Island_Fireball(float x, float z, color_t color) {
    this->position = glm::vec3(x, 0, z);
    // Our vertices. Three consecutive floats give a 3D vertex; Three consecutive vertices give a triangle.
    // A cube has 6 faces with 2 triangles each, so this makes 6*2=12 triangles, and 12*3 vertices
    static const GLfloat vertex_buffer_data[] = {
        -2.0f,-2.0f,-2.0f, // triangle 3 : begin
        -2.0f,-2.0f, 2.0f,
        -2.0f, 2.0f, 2.0f, // triangle 3 : end
...
void Island_Fireball::draw(glm::mat4 VP) {
...
void Island_Fireball::set_position(float x, float z) {
    this->position = glm::vec3(x, 0, z);
}

void Island_Fireball::tick(float camera_rotation_angle,float val) 
{
